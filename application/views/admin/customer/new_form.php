						...
						<form action="<?php base_url('admin/customer/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('customer_id') ? 'is-invalid':'' ?>"
								 type="number" name="id" placeholder="Customer ID" style="border-color:#9fff7a;"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="name" min="0" placeholder="Customer Name" style="border-color:#9fff7a;"/>
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
								 type="text" name="address" min="0" placeholder="Customer Address" style="border-color:#9fff7a;"/>
								<div class="invalid-feedback">
