						...
						<form action="<?php base_url('admin/supplier/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('supplier_id') ? 'is-invalid':'' ?>"
								 type="number" name="ID" placeholder="Supplier ID" value="<?php echo $supplier->supplier_id ?>" style="border-color:#9fff7a;"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('supplier_name') ? 'is-invalid':'' ?>"
								 type="text" name="name" min="0" placeholder="Supplier Name" value="<?php echo $supplier->supplier_name?>" style="border-color:#9fff7a;" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('supplier_address') ? 'is-invalid':'' ?>"
								 type="text" name="address" min="0" placeholder="Supplier Address" value="<?php echo $supplier->supplier_address ?>" style="border-color:#9fff7a;"/>
								<div class="invalid-feedback">
